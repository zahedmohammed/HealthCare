...
public class ProjectFileServiceImpl extends GenericServiceImpl<com.fxlabs.fxt.dao.entity.project.ProjectFile, ProjectFile, String> implements ProjectFileService {
    ...
    public Response<ProjectFile> saveFromTestSuite(TestSuite dto, String projectId) {
        ...
        return saveProjectFile(projectId, fileName, content, modified, md5Hex, dto.getAutoGenerated(), dto.getCategory().toString());
    }
    ...
    private Response<ProjectFile> saveProjectFile(String projectId, String fileName, String content, String modified, String md5Hex, Boolean autGenerated, String category) {
        ...
        projectFile.setAutoGenerated(autGenerated);
