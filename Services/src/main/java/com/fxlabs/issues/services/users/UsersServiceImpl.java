...
import com.fxlabs.issues.dao.repository.jpa.*;
...
@Service
@Transactional
public class UsersServiceImpl extends GenericServiceImpl<Users, com.fxlabs.issues.dto.users.Users, String> implements UsersService {
    ...
    @Override
    public Response<com.fxlabs.issues.dto.users.Users> findByEmail(String email) {
        Optional<Users> usersOptional = ((UsersRepository) repository).findByEmail(email);

        if (usersOptional.isPresent()) {
            return new Response<com.fxlabs.issues.dto.users.Users>(converter.convertToDto(usersOptional.get()));
        }
        return new Response<com.fxlabs.issues.dto.users.Users>().withErrors(true).withMessage(new Message(MessageType.ERROR, "", String.format("Invalid email or password")));
    }

    @Override
    public Response<com.fxlabs.issues.dto.users.Users> findById(String id) {
        Optional<Users> usersOptional = ((UsersRepository) repository).findById(id);

        if (usersOptional.isPresent()) {
            return new Response<com.fxlabs.issues.dto.users.Users>(converter.convertToDto(usersOptional.get()));
        }
        return new Response<com.fxlabs.issues.dto.users.Users>().withErrors(true).withMessage(new Message(MessageType.ERROR, "", String.format("Invalid id")));
    }
    ...
    @Override
    public Response<com.fxlabs.issues.dto.users.UsersPassword> findActivePassword(String email) {
        Response<com.fxlabs.issues.dto.users.Users> usersResponse = findByEmail(email);
        ...
        if (usersPasswordOptional.isPresent()) {
            return new Response<com.fxlabs.issues.dto.users.UsersPassword>(usersPasswordConverter.convertToDto(usersPasswordOptional.get()));
        }
        return new Response<com.fxlabs.issues.dto.users.UsersPassword>().withErrors(true).withMessage(new Message(MessageType.ERROR, "", String.format("No active password found!")));
    }

    @Override
    public Response<Boolean> personalSignUp(com.fxlabs.issues.dto.users.Users users) {
    ...
    @Override
    public Response<Boolean> teamSignUp(com.fxlabs.issues.dto.users.Users users) {
        return signUp(users, users.getCompany(), OrgType.TEAM, Arrays.asList("ROLE_USER", "ROLE_ADMIN"));
    }

    @Override
    public Response<Boolean> enterpriseSignUp(com.fxlabs.issues.dto.users.Users users) {
        return signUp(users, users.getCompany(), OrgType.ENTERPRISE, Arrays.asList("ROLE_USER", "ROLE_ADMIN", "ROLE_ENTERPRISE"));
    }

    @Override
    public Response<Boolean> addToOrg(com.fxlabs.issues.dto.users.OrgUsers orgUsers, String user) {
    ...
    private Response<Boolean> signUp(com.fxlabs.issues.dto.users.Users users, String orgName, OrgType orgType, List<String> roles) {

        Response<Boolean> response = new Response<>(false);
        try {


            Response<com.fxlabs.issues.dto.users.Users> addUserResponse = addUser(users, roles);
    ...
    @Override
    public Response<com.fxlabs.issues.dto.users.Users> addUser(com.fxlabs.issues.dto.users.Users users, List<String> roles) {
        // check email exists
