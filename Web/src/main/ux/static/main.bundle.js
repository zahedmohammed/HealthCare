...
var IssuesEditComponent = (function () {
    function IssuesEditComponent(skillSubscriptionService, skillService, orgService, route, router) {
        ...
        this.subscription = new __WEBPACK_IMPORTED_MODULE_5__models_subscription_model__["a" /* Subscription */]();
    ...
    IssuesEditComponent.prototype.delete = function () {
        var _this = this;
        console.log(this.subscription);
        this.skillSubscriptionService.deleteITBot(this.subscription).subscribe(function (results) {
            _this.showSpinner = false;
            if (results['errors']) {
                // TODO - handle errors
                return;
...
var IssuesListComponent = (function () {
    ...
    IssuesListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.showSpinner = true;
        this.skillSubscriptionService.get("ISSUE_TRACKER").subscribe(function (results) {
            _this.showSpinner = false;
            if (results['errors']) {
                // TODO - handle errors
                return;
...
var IssuesNewComponent = (function () {
    ...
    IssuesNewComponent.prototype.create = function () {
        ...
        this.showSpinner = true;
        this.skillSubscriptionService.createITBot(this.entry).subscribe(function (results) {
            _this.showSpinner = false;
            if (results['errors']) {
                // TODO - handle errors
                return;
...
var JobslistComponent = (function () {
    ...
    JobslistComponent.prototype.list = function () {
        var _this = this;
        this.jobsService.get().subscribe(function (results) {
            _this.showSpinner = false;
            if (!results)
                return;
...
var ProjectsEditComponent = (function () {
    function ProjectsEditComponent(projectService, orgService, route, router) {
        this.projectService = projectService;
        this.orgService = orgService;
        this.route = route;
        this.router = router;
...
var VaultEditComponent = (function () {
    function VaultEditComponent(vaultService, orgService, route, router) {
...
var JobsService = (function () {
    ...
    JobsService.prototype.get = function () {
...
var SkillSubscriptionService = (function () {
     ...
     */
    SkillSubscriptionService.prototype.get = function (type) {
        return this.http.get(this.serviceUrl + "/skill-type/" + type);
    };
    SkillSubscriptionService.prototype.getById = function (id) {
        return this.http.get(this.serviceUrl + "/" + id);
    };
    SkillSubscriptionService.prototype.createITBot = function (obj) {
    ...
    SkillSubscriptionService.prototype.deleteITBot = function (obj) {
