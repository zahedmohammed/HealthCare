    ...
    private static AutoSuggestion populateAutoSuggestDetails(TestSuiteCategory category) {
        ...
        switch (category) {
            case UnSecured:
                ...
                autoSuggestion.setEstimates("Typically this fix would take less than 8 hours for a mid-level developer. ");
...
//                break;
            case RBAC:
                ...
                autoSuggestion.setEstimates("Typically this fix would take less than 16 hours for a mid-level developer. ");
