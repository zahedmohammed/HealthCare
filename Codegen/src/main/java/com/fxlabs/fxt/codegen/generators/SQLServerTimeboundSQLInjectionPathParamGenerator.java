 ...
 * @since 4/24/2018
 */
@Component(value = "SQLServerTimeboundSqlInjectionPathParamGenerator")
public class SQLServerTimeboundSQLInjectionPathParamGenerator extends AbstractGenerator {
