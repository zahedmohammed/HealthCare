 ...
 * @since 4/24/2018
 */
@Component(value = "mongoDBSqlInjectionQueryParamGenerator")
public class MongoDBSQLInjectionQueryParamGenerator extends AbstractGenerator {
            ...
            for (Parameter param : op.getParameters()) {
                if (param instanceof QueryParameter) {
                    ...
                    for (TestSuiteMin testSuite : testSuites) {
                        ...
                        testSuite.setEndpoint(path + "?" + queryParam.getName() + "=" + "{{@MongoDBSQLInjections | sample:all }}");
