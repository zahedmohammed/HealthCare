        ...
        if (method == io.swagger.models.HttpMethod.GET) {
            for (Parameter param : op.getParameters()) {
                ...
                if (param instanceof QueryParameter) {
                    ...
                    List<TestSuiteMin> testSuites = build(op, path_, path, postFix, SCENARIO, op.getDescription(), TestSuiteType.SUITE, method, TAG, AUTH, null, configUtil.getAssertions(SCENARIO));
