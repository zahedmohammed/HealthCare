...
@Component(value = "invalidEmptyCredGenerator")
public class InvalidCredEmptyGenerator extends AbstractGenerator {

    protected static final String SCENARIO = "auth_invalid_empty";
    protected static final String AUTH = "Invalid_Auth_Empty";
