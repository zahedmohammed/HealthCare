 ...
 * @since 4/24/2018
 */
@Component(value = "postgresTimeboundSqlInjectionQueryParamGenerator")
public class PostgresTimeboundSQLInjectionQueryParamGenerator extends AbstractGenerator {
