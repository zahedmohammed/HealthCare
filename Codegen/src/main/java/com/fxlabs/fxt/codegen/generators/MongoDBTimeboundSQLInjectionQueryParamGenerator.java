 ...
 * @since 4/24/2018
 */
@Component(value = "mongoDBTimeboundSqlInjectionQueryParamGenerator")
public class MongoDBTimeboundSQLInjectionQueryParamGenerator extends AbstractGenerator {
    ...
    protected static final String INJECTION_DATASET = "@MongoDBTimeboundSQLInjections";
