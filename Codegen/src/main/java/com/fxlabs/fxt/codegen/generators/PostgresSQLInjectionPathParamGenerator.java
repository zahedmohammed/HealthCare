 ...
 * @since 4/24/2018
 */
@Component(value = "PostgresSqlInjectionPathParamGenerator")
public class PostgresSQLInjectionPathParamGenerator extends AbstractGenerator {

    protected static final String POSTFIX = "path_param_sql_injection_Postgres";
    protected static final String AUTH = "Default";// BASIC
    protected static final String OPERAND = "200";
    protected static final String INJECTION_DATASET = "@PostgresSQLInjections";
