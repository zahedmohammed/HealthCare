...
public abstract class Validator {
    ...
    protected void validationFailed(String operand1, String operand2, AssertionContext context, String assertion) {
        ...
        logger.info(String.format("Assertion failed expected value [{}] but was [{}]", operand1, operand2));
        context.getLogs().append(String.format("Assertion [%s] failed expected value [%s] but was [%s]", assertion, operand1, operand2));
    }
}
