...
public class IssueController {
    ...
    public Response<Issue> updateFromUI(@Valid @RequestBody Issue dto) {
        return issueService.updateFromUI(dto, SecurityUtil.getCurrentAuditor(), SecurityUtil.getOrgId());
    }
